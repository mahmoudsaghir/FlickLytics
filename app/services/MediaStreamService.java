...
/**
 * singleton service that owns the shared Pekko Broadcasthub for live movie/tv detail updates
 * any component can call push(item) to emit a result to all currently
 * connected websocket clients. each client's mediadetailsactor then filters the broadcast by its own mediatype and
 * dedup set.
 * <p>
...
public class MediaStreamService {
    ...
    /**
     * share source produced by the broadcasthub
    ...
    /**
     * constructs the service and immediately materializes the
